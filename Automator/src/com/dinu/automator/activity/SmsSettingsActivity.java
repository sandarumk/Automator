...
public class SmsSettingsActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ButtonFloat setLocation = (ButtonFloat) findViewById(R.id.button_sms_set_location);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			...
			case CONTACT_PICKER_RESULT:
				...
				Cursor cursor = getContentResolver().query(Phone.CONTENT_URI, null, Phone.CONTACT_ID + "=?",
						new String[] { id }, null);
	...
	private void showSaveChangesDialog(final Context context) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setMessage("Do you want to save changes to the the sms?")
